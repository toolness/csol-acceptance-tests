...
var ENV = {
  CSOL_SITE: {
    ...
    CSOL_AWS_FAKE_S3_DIR: abspath('data/csol-fake-s3'),
    CSOL_MANDRILL_KEY: '',
  ...
  AESTIMIA: {
    ...
    DEBUG: '',
    ENABLE_STUBBYID: '',
    THEME_DIR: abspath('aestimia/theme/csol')
  },
  OPENBADGER: {
    PORT: (PORT + 2).toString(),
    NODE_ENV: 'development',
    THEME_DIR: abspath('openbadger/themes/csol'),
    OPENBADGER_ENABLE_STUBBYID: '',
    OPENBADGER_AWS_FAKE_S3_DIR: abspath('data/openbadger-fake-s3'),
    OPENBADGER_HOST: 'localhost',
    OPENBADGER_PROTOCOL: 'http',
    OPENBADGER_LOGDIR: abspath('data/openbadger-log'),
